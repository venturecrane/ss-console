...
export const SKILL_SUMMARIES: Record<string, string> = {
  ...
  'medical-chronology-maintainer':
    'Builds a cited medical chronology on a matter when an administrator asks, and updates a delivered one by reading only the records it did not cover. Extractive only, never characterizes causation.',
