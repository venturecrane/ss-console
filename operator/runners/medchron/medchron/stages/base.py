...
class StageRun:
    ...
    date_stamp: str = ""
    #: Called with the stage name before every paid model call. The driver
    #: binds it to the cost limits, so a limit reached inside a long stage
    #: stops the run at the next call rather than at the next stage.
